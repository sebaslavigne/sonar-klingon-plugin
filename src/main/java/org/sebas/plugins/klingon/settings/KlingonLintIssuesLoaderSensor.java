 ...
 */
public class KlingonLintIssuesLoaderSensor implements Sensor {

  private static final Logger LOGGER = Loggers.get(KlingonLintIssuesLoaderSensor.class);

  protected static final String REPORT_PATH_KEY = "sonar.klingonlint.reportPath";
   ...
   */
  public KlingonLintIssuesLoaderSensor(final Configuration config, final FileSystem fileSystem) {
    this.config = config;
